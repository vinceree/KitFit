"use strict";(()=>{var A=Object.defineProperty;var O=(f,l,c)=>l in f?A(f,l,{enumerable:!0,configurable:!0,writable:!0,value:c}):f[l]=c;var p=(f,l,c)=>O(f,typeof l!="symbol"?l+"":l,c);(function(){let f={apiUrl:"https://kitfit.app",buttonText:"Try it on your bike \u2192"},l="kf-pending-job",c="kf-completed-job",C=3e3,y=300*1e3,F=`
  ...
  `,M=[{id:"alpine",name:"Alpine",desc:"Mountain road, sunny"},{id:"coastal",name:"Coastal",desc:"Ocean road, bright"},{id:"forest",name:"Forest",desc:"Tree-lined, dappled light"},{id:"urban",name:"Urban",desc:"City streets, dawn"}],x="kf-person-photos",w="kf-bike-photos",J=3;function E(r){try{return JSON.parse(sessionStorage.getItem(r)||"[]")}catch{return[]}}function S(r,e){let t=E(r).filter(o=>o.name!==e.name);t.unshift(e),t.length>J&&t.pop();try{sessionStorage.setItem(r,JSON.stringify(t))}catch{t.pop();try{sessionStorage.setItem(r,JSON.stringify(t))}catch{}}}function L(r,e=1600,t=.85){return new Promise((o,i)=>{let n=new Image;n.onload=()=>{let{width:a,height:s}=n;(a>e||s>e)&&(a>s?(s=s/a*e,a=e):(a=a/s*e,s=e));let d=document.createElement("canvas");d.width=a,d.height=s,d.getContext("2d").drawImage(n,0,0,a,s),URL.revokeObjectURL(n.src),o(d.toDataURL("image/jpeg",t))},n.onerror=()=>{URL.revokeObjectURL(n.src),i(new Error("Failed to load image for compression"))},n.src=URL.createObjectURL(r)})}function j(r,e){let[t,o]=r.split(","),i=t.match(/:(.*?);/)?.[1]||"image/jpeg",n=atob(o),a=new Uint8Array(n.length);for(let s=0;s<n.length;s++)a[s]=n.charCodeAt(s);return new File([a],e,{type:i})}function R(){if(document.getElementById("kf-toast-styles"))return;let r=document.createElement("style");r.id="kf-toast-styles",r.textContent=`
    ...
    `,document.head.appendChild(r)}function u(r,e){k(),R();let t=document.createElement("div");t.id="kf-toast-notification",t.innerHTML=`
